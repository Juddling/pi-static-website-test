...
return null},hg=!1;if(K.querySelectorAll)try{var ig=K.querySelectorAll(":root");ig&&1==ig.length&&ig[0]==K.documentElement&&(hg=!0)}catch(a){}var eg=hg;var Ld={},O=null,wg=Math.random();Ld.C="GTM-TZPTKRR";Ld.Wb="8c0";Ld.di="";var xg={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},yg="www.googletagmanager.com/gtm.js";
var zg=yg,Ag=null,Bg=null,Cg="//www.googletagmanager.com/a?id="+Ld.C+"&cv=66",Dg={},Eg={},Fg=function(){var a=O.sequence||1;O.sequence=a+1;return a};
...
function Pr(a,b){}var X={b:{}};X.b.ctv=["google"],function(){(function(a){X.__ctv=a;X.__ctv.g="ctv";X.__ctv.h=!0;X.__ctv.priorityOverride=0})(function(){return"66"})}();
...
X.b.f=["google"],function(){(function(a){X.__f=a;X.__f.g="f";X.__f.h=!0;X.__f.priorityOverride=0})(function(a){var b=ep("gtm.referrer",1)||K.referrer;return b?a.vtp_component&&"URL"!=a.vtp_component?th(vh(String(b)),a.vtp_component,a.vtp_stripWww,a.vtp_defaultPages,a.vtp_queryKey):dp(String(b)):String(b)})}();X.b.k=["google"],function(){(function(a){X.__k=a;X.__k.g="k";X.__k.h=!0;X.__k.priorityOverride=0})(function(a){return hp(a.vtp_name,ep("gtm.cookie",1),!!a.vtp_decodeCookie)[0]})}();
...
function(){var h=ef(V("UET"),{ti:c.vtp_tagId,q:e});B[d]=h;h.push("pageLoad");c.vtp_gtmOnSuccess()},c.vtp_gtmOnFailure),a=!0}catch(h){N(c.vtp_gtmOnFailure)}};X.__baut=b;X.__baut.g="baut";X.__baut.h=!0;X.__baut.priorityOverride=0}();X.b.logging=["google"],function(){function a(){return{}}(function(b){X.__logging=b;X.__logging.g="logging";X.__logging.h=!0;X.__logging.priorityOverride=0})(function(b){var c=b.vtp_environments||"debug",d=b.vtp_createPermissionError;return{assert:function(e){if("all"!==c&&!Qp.Tg())throw d(e,{},"Logging is not enabled in all environments");},J:a}})}();X.b.smm=["google"],function(){(function(a){X.__smm=a;X.__smm.g="smm";X.__smm.h=!0;X.__smm.priorityOverride=0})(function(a){var b=a.vtp_input,c=Up(a.vtp_map,"key","value")||{};return c.hasOwnProperty(b)?c[b]:a.vtp_defaultValue})}();
